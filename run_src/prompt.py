direct_answer_no_hints_prompt = """You are a Python assistant. You need to solve the Python programming problem. ONLY provide the function implementation code.
